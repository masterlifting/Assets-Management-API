...
public class RestMethodRead<TEntity, TGet> where TGet : class where TEntity : class, IDataIdentity, IPeriod
{
    private readonly IRestQueryService<TEntity> queryService;
    private readonly IMapperRead<TEntity, TGet> mapper;

    protected RestMethodRead(IRestQueryService<TEntity> queryService, IMapperRead<TEntity, TGet> mapper)
    {
