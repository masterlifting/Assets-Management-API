...
public class ReportRepository : RepositoryHandler<Report, DatabaseContext>
{
    ...
    public override Task SetPostProcessAsync(RepositoryActions action, Report entity)
    {
        ...
        publisher.PublishTask(QueueNames.MarketAnalyzer, QueueEntities.Report, QueueActions.CreateUpdate, data);
    ...
    public override Task SetPostProcessAsync(RepositoryActions action, IReadOnlyCollection<Report> entities)
    {
        ...
        var publisher = new RabbitPublisher(rabbitConnectionString, QueueExchanges.Transfer);
        publisher.PublishTask(QueueNames.MarketAnalyzer, QueueEntities.Reports, QueueActions.CreateUpdate, data);
