...
using IM.Services.Analyzer.Api.Services.Calculators.Interfaces.CoefficientCalculator;
using System;
using System.Collections.Generic;

namespace IM.Services.Analyzer.Api.Services.Calculators.Implementations.CoefficientCalculator
{
