...
namespace IM.Service.MarketData.Domain.DataAccess;
...
public class DatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Source>().HasData(
            new() { Id = (byte)Enums.Sources.Manual, Name = nameof(Enums.Sources.Manual), Description = "For data from manual input" },
            new() { Id = (byte)Enums.Sources.Official, Name = nameof(Enums.Sources.Official), Description = "For data from official site/api" },
            new() { Id = (byte)Enums.Sources.Moex, Name = nameof(Enums.Sources.Moex), Description = "For data from Moscow Exchange" },
            new() { Id = (byte)Enums.Sources.Tdameritrade, Name = nameof(Enums.Sources.Tdameritrade), Description = "For from from Tdameritrade.com" },
            new() { Id = (byte)Enums.Sources.Investing, Name = nameof(Enums.Sources.Investing), Description = "For data from Investing.com" });
