...
using static IM.Services.Company.Reports.Services.ReportServices.ReportLoaderHelper;
...
namespace IM.Services.Company.Reports.Services.ReportServices
{
    public class ReportLoader
    {
        ...
        public ReportLoader(ReportsContext context, RepositorySet<Report> repository, ReportParser parser)
        {
