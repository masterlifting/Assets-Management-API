...
namespace IM.Service.Common.Net.RepositoryService.Comparators
{
    ...
    {
        public bool Equals(T? x, T? y) => (x!.CompanyId, x.Year, x.Quarter) == (y!.CompanyId, y.Year, y.Quarter);
        public int GetHashCode(T obj) => (obj.CompanyId, obj.Year, obj.Quarter).GetHashCode();
    }
}
